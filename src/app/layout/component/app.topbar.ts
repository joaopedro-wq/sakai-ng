...
@Component({
    ...
    template: ` <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            ...
            <!-- Botão de usuário — sempre visível, fora do menu ocultável -->
            <div class="relative">
                <button type="button" class="layout-topbar-action"
                    ...
                    @if (avatarUrl) {
                        <img [src]="avatarUrl"
                             alt="Avatar"
                             class="w-8 h-8 rounded-full object-cover ring-2 ring-offset-1"
...
export class AppTopbar implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.authService.obsGetLoggedUser.subscribe(user => {
    ...
    onLogout(): void {
        this.authService.logout().subscribe({
            complete: () => localStorage.removeItem('avatar')
        });
    }
}
